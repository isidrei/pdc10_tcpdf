...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // set bacground image
        $img_file = K_PATH_IMAGES.'sid.jpg';
...
// Print a text
$html = '<span style="background-color:;color:white;">&nbsp;Personal Information&nbsp;</span>
<p stroke="0.2" fill="true" strokecolor="black" color="white" style="font-family:helvetica;font-weight:bold;font-size:24pt;">
Complete Name: Dan Isidrei Musni<br>
Program: CCS<br>
Email: musni.danisidrei@auf.edu.ph<br>
Address: Dona Belen Subdivision, Angeles City Pampanga<br>
Student Number: 18-0173-228</p>';
